    ...
    <Container className="vh-100 d-flex flex-column flex-lg-row justify-content-center align-items-center">
      ...
      <div className="">
        ...
        <p>
          ...
          residents of the Rio Grande Valley. Our mission is to provide
          exceptional care through teamwork, compassion, patient-centered
          practices and continuous innovation. At Family Imaging of South Texas,
          we pride ourselves on providing the most advanced imaging services
          with a patient-first approach. Our team of highly skilled radiologists
          and technologists are committed to providing you with the most
          accurate MRI imaging in a comfortable and caring environment. Whether
          you or your family needs an x-ray, ultrasound or full body MRI, you
          can trust our family to provide the highest standard of care.
        </p>
        <Marquee>
